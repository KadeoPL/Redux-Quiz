...
import { answerQuestion, nextQuestion, prevQuestion, resetQuiz } from "../store/slices/quizSilce";
import Question from './Question.jsx';
import Score from './Score.jsx';

export default function Quiz(){
    
    const {questions, currentQuestionIndex, score, answers} = useSelector((state) => state.quiz);
